...
public class HintConstant {
    ...
    public static final String BLOG_AUTHOR_UN_FOLLOW_SUCCESS = "取消关注成功";

    public static final String BLOG_AUTHOR_FOLLOW_ERROR = "操作失败, 网络出问题了";

    public static final String COMMENT_SUCCESS = "回复成功";

    public static final String COMMENT_ERROR = "回复失败, 网络出问题了";
